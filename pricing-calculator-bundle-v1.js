      ...
      <div class="grid grid--center grid--waffle grid--price price">
        ...
        <div class="grid__column grid__column--12 grid__column--6@small grid__column--5@large">
          <div class="price__calc">
            <h4>Concierge + Instant Booker</h4>
<p>Route and schedule meetings directly from your web forms. Automate every step along the meeting lifecycle.</p>

            <div class="switch switch--horizontal switch--horizontal__checkbox" style="display:none;">
              <input id="checkked-2" type="checkbox" name="checked-2" value="Buy Concierge" checked="checked">
              <label for="checkked-2">Buy Concierge</label><span class="toggle-outside"><span class="toggle-inside"></span></span>
            </div>
            ...
            <div class="grid grid--stackable">
              ...
              <div class="grid__column">
                <input type="text" value="1" maxlength="5" name="seats3" class="seats" tabindex="1">
              </div>
            </div>
            ...
            <div class="grid grid--stackable">
              ...
              <div class="grid__column">
                <input type="text" value="1" maxlength="4" name="seats4" class="seats" tabindex="2">
              </div>
            </div>
          </div>
          
          <div class="price__calc" style="display:none;">
            <h4>Instant Booker</h4>
<p>How many team members will be booking meetings or having meetings booked for them?</p>
            <div class="switch switch--horizontal switch--horizontal__checkbox">
              <input id="checkked-1" type="checkbox" name="checked-1" value="Buy Instant Booker">
              <label for="checkked-1">Buy Instant Booker</label><span class="toggle-outside"><span class="toggle-inside"></span></span>
            </div>
            <div class="grid grid--stackable">
              <div class="grid__column">
                <span class="h5 heading">Hot Users</span>
                                <span class="table__tooltip">
                  <img src="https://www.chilipiper.com/wp-content/themes/chilipiper/public/images/pricing/question-mark.svg" alt="">
                  <span class="table__tooltip-content">
                    <p>Required for users in routing queues. (Ex. SDR booking a handoff meeting for an AE)</p>
                  </span>
                </span>
                              </div>
              <div class="grid__column">
                <input type="text" value="1" maxlength="4" name="seats" class="seats" tabindex="3">
              </div>
            </div>
            ...
            <div class="grid grid--stackable">
              <div class="grid__column">
                <span class="h5 heading">Spicy Users</span>
                  ...
                  <img src="https://www.chilipiper.com/wp-content/themes/chilipiper/public/images/pricing/question-mark.svg" alt="">
                  <span class="table__tooltip-content">
                    <p>Entry license to connect users to your CRM.</p>
                  </span>
                </span>
                              </div>
              <div class="grid__column">
                <input type="text" value="1" maxlength="4" name="seats2" class="seats" tabindex="4">
              </div>
            </div>
          ...
          <div class="price__calc" style="display:none;">
            <h4>Routing</h4>
<p>Do you want to automatically route leads and meetings based on customizable rules and round robin?</p>
        ...
        <div class="grid__column grid__column--12 grid__column--6@small">
          <div class="price__box price__box--orange">
            <h1>$<span class="final-price">0</span> <span class="price__label price__label--standard">per month (billed at $NaN per year)</span></h1>
            ...
            <div class="price__text-orange">
              <p>Save $<span class="price__save">NaN</span> per month with <span>annual billing</span></p>
            </div>

            <div class="price__box--repeat price__box--concierge">
              <h4>CONCIERGE + INSTANT BOOKER</h4>

              <div class="price__box--column">
                <div class="float-left">
                  <h3>Platform Fee. <span class="h3 price__platform-label">Spicy</span></h3>
                </div>
              ...
              <div class="price__box--column">
                ...
                <div class="float-right">
                  <p><span class="price__value price__value--standard4 fw-bold">xundefined</span>$<span class="unit-price4">30</span> per user</p>
                </div>
              </div><!-- .column-->
            </div>
            ...
            <div class="price__box--repeat price__box--instant" style="display:none;">
              ...
              <div class="price__box--column">
                ...
                <div class="float-right">
                  <p><span class="price__value price__value--standard fw-bold">xundefined</span>$<span class="unit-price">15</span> per user</p>
                </div>
              </div><!-- .column-->
              ...
              <div class="price__box--column">
                ...
                <div class="float-right">
                  <p><span class="price__value price__value--standard2 fw-bold">x1</span>$<span class="unit-price2"></span> per user</p>
                </div>
              </div><!-- .column-->
            </div>
